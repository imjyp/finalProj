...
public class UploadController {
	...
	//파일이 업로드 될 대상 폴더
//	String uploadPath = "D:\\A_TeachingMaterial\\FinalProj\\workspace\\proj\\src\\main\\resources\\static\\upload";
	...
	public long multiImageUpload(MultipartFile[] multipartFiles) {
		...
		for(MultipartFile multipartFile : multipartFiles) {
			...
			try {
				...
				fileDetailVO.setFileNo(++counter);							//복합키(P.K). 1, 			2, 			 3..
	...
	public ResponseEntity<Resource> download(
		...
		resourceName = resourceName.substring(resourceName.lastIndexOf("_")+1);//phone01.jpg
