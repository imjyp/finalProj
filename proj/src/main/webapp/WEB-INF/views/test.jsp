			...
			<div class="mainEvent basicSwiper">
				<div class="swiper swiper-container swiper-container-horizontal">
					<ul class="swiper-wrapper"
						style="transition-duration: 0ms; transform: translate3d(-7680px, 0px, 0px);">
						<li class="swiper-slide" data-swiper-slide-index="0"
							style="width: 1280px; visibility: hidden;"><a
							href="/itdmenu"><img src="/upload/a.png"></a></li>
						<li class="swiper-slide" data-swiper-slide-index="1"
							style="width: 1280px; visibility: hidden;"><a
							href="/itdmenu"><img src="/upload/b.png"></a></li>
						<li class="swiper-slide" data-swiper-slide-index="2"
							style="width: 1280px; visibility: hidden;"><a
							href="/companyInfo/test"><img src="/upload/c.png"></a></li>
					</ul>
				...
				<div class="indicator" >
					<span role="text" class="timer"><span class="bar"
						style="width: 72.7835%; overflow: hidden;"></span></span>
					<button type="button" class="play pause">배너 롤링 정지</button>
					<!-- 재생표시 <button type="button" class="play">재생</button> -->
				</div>
			</div>
			<!-- //mainEvent -->
			<div class="contArea mainCont"style="margin-top:10px">
				<div>
					<a href="/findingstore" class="btn btn-warning rounded-pill">매장
						찾기</a> <a href="/itdmenu" class="btn btn-warning rounded-pill">메뉴
						소개</a>
				...
				<div class="slider-container" style="margin-top:100px">
					<div class="slider">
						<c:forEach var="menu" items="${menuList }">
							<div class="slide">
								<img src="/resources${menu.fileDetailList[0].fileSaveLocate}"
									alt="${menu.menuNm }">
								<div class="slide-content">
									<strong class="menunm">${menu.menuNm }</strong> <br>
									<br> <strong class="menucn">${menu.menuCn }</strong>
								</div>
							</div>
						</c:forEach>
					</div>
	...
	setInterval(() => {
	  ...
	  document.querySelector('.slider').scrollTo({
		...
		function goDetail(element) {
			...
			if (certification !== "N") {
				var certPopup = window.open('about:blank', 'certviewer',
...
<li><a href="#" onclick="goDetail(this)" data-seq="{seq}" data="{seq},{certification},{pc_kor_link}">
								<div class="tmb"><img src="{pc_kor_image_url}" alt=""></div>
								<div class="con">
									<span class="blind">{pc_kor_alt}</span>
...
/* 버튼 컨테이너 스타일링 */
.contArea.mainCont>div:first-child {
	text-align: center;
	margin-bottom: 50px;
}
