                            ...
                            <div class="list-group list-group-messages">
                                <a href="#" class="list-group-item pt-0 active" id="inbox-menu">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="/dist/assets/static/images/bootstrap-icons.svg#envelope" />
                                        </svg>
                                    </div>
                                    Inbox
                                    <span
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="/dist/assets/static/images/bootstrap-icons.svg#archive" />
                                        </svg>
                                    </div>
                                    Sent
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="/dist/assets/static/images/bootstrap-icons.svg#pencil" />
                                        </svg>
                                    </div> Draft
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use xlink:href="/dist/assets/static/images/bootstrap-icons.svg#star" />
                                        </svg>
                                    </div>
                                    Starred
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="/dist/assets/static/images/bootstrap-icons.svg#info-circle" />
                                        </svg>
                                    </div>
                                    Spam
                                    <span
                                ...
                                <div class="email-action">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <span class="fonticon-wrap">
                                                            ...
                                                            <svg class="bi" width="1.5em" height="1.5em"
                                                                fill="currentColor">
                                                                <use
                                                                    xlink:href="/dist/assets/static/images/bootstrap-icons.svg#folder" />
                                                            </svg>
                                                        </span>
                                                    </button>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <span class="fonticon-wrap">
                                                            ...
                                                            <svg class="bi" width="1.5em" height="1.5em"
                                                                fill="currentColor">
                                                                <use
                                                                    xlink:href="/dist/assets/static/images/bootstrap-icons.svg#tag" />
                                                            </svg>
                                                        </span>
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-right"
                                    ...
                                    <div
                                        ...
                                        <button class="btn btn-icon email-pagination-prev action-button d-none d-sm-block">
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="/dist/assets/static/images/bootstrap-icons.svg#chevron-left" />
                                            </svg>
                                        </button>
                                        <button class="btn btn-icon email-pagination-next action-button d-none d-sm-block">
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="/dist/assets/static/images/bootstrap-icons.svg#chevron-right" />
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="email-user-list list-group ps ps--active-y">
                                    <ul class="users-list-wrapper media-list">
                                        <li class="media mail-read">
                                            <div class="user-action">
                                                ...
                                                <span class="favorite text-warning">
                                                    <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                        <use
                                                            xlink:href="/dist/assets/static/images/bootstrap-icons.svg#star-fill" />
                                                    </svg>
                                                </span>
                                            </div>
                                            <div class="pr-50">
                                                <div class="avatar">
                                                    <img src="/dist/assets/compiled/jpg/1.jpg" alt="avtar img holder">
                                                </div>
                                            </div>
                                        ...
                                        <li class="media mail-read">
                                            <div class="user-action">
                                                ...
                                                <span class="favorite">
                                                    <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                        <use
                                                            xlink:href="/dist/assets/static/images/bootstrap-icons.svg#star" />
                                                    </svg>
                                                </span>
                                            </div>
                                            <div class="pr-50">
                                                <div class="avatar">
                                                    <img class="rounded-circle" src="/dist/assets/compiled/jpg/3.jpg"
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="pr-50">
                                                <div class="avatar">
                                                    <img class="rounded-circle" src="/dist/assets/compiled/jpg/7.jpg"
                                                        alt="Generic placeholder image">
                                                </div>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="pr-50">
                                                <div class="avatar">
                                                    <img class="rounded-circle" src="/dist/assets/compiled/jpg/5.jpg"
                                                        alt="Generic placeholder image">
                                                </div>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <li class="media mail-read">
                                            ...
                                            <div class="pr-50">
                                                <div class="avatar">
                                                    <img class="rounded-circle" src="/dist/assets/compiled/jpg/8.jpg"
                                                        alt="Generic placeholder image">
                                                </div>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <li class="media mail-read">
                                            ...
                                            <div class="pr-50">
                                                <div class="avatar">
                                                    <img class="rounded-circle" src="/dist/assets/compiled/jpg/6.jpg"
                                                        alt="Generic placeholder image">
                                                </div>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="pr-50">
                                                <div class="avatar">
                                                    <img class="rounded-circle" src="/dist/assets/compiled/jpg/1.jpg"
                                                        alt="Generic placeholder image">
                                                </div>
                                            </div>
                                            <div class="media-body">
                                                        ...
                                                        <div class="card-footer pt-0 border-top">
                                                            ...
                                                            <ul class="list-unstyled mb-0">
                                                                <li class="cursor-pointer pb-25">
                                                                    <img src="/dist/app-assets/static/images/icon/psd.png"
                                                                        alt="psd.png" height="30">
                                                                    <small
                                                                        class="text-muted ms-1 attchement-text">uikit-design.psd</small>
                                                                </li>
                                                                <li class="cursor-pointer">
                                                                    <img src="/dist/app-assets/static/images/icon/sketch.png"
                                            ...
                                            <div class="card collapse-header" role="tablist">
                                                <div id="headingCollapse6"
                                                    ...
                                                    <div class="collapse-title media">
                                                        <div class="pr-1">
                                                            <div class="avatar me-3">
                                                                <img src="/dist/assets/static/images/faces/19.jpg"
                                                                    alt="avtar img holder" width="30" height="30">
                                                            </div>
                                                        </div>
                                                        <div class="media-body mt-25">
