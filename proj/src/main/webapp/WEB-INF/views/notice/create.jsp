	...
	<div class="page-heading">
		...
		<section class="section">
			<div class="card col-md-12">
				<form id="frm" action="/notice/createPost" method="post">
					<div class="card-body">
						<div class="row">
							<div >
								<!-- 공지사항 상세내역 시작 -->
							...
							<div class="col-12">
								...
								<div class="form-group col-md-3">
									<label for="boardStart">게시 시작</label> <input 
										type="date" class="form-control" id="boardStart"
										name="boardStart" required>
								</div>
								<div class="form-group col-md-3">
									<label for="boardEnd">게시 종료</label> <input type="date"
										class="form-control" id="boardEnd" name="boardEnd"
										required>
								</div>
								<!-- 공지사항 상세내역 끝 -->
					...
					<span id="spn2" class="justify-between">
						<span style="float: left">
							...
							<a href="/notice/list"	class="btn btn-success btn-user"> 취소 </a>
					</span>
					</span>
					<!-- 수정모드 끝 -->
				</form>
