...
<%@ include file="../include/top.jsp" %>
	...
	<div class="row mb-2 align-items-center">
         <ol class="breadcrumb float-sm-end">
            ...
            <li class="breadcrumb-item active" style="font-size:2rem"><a href="/bonsa/sellingDate">기간별 매출</a></li>
         </ol>
   </div>
			...
			<div class="row" id="table-hover-row" >
				<div class="col-7" >
		 		...
		 		<div class="row" style="margin-left:30px;" >
			 		<div class="card col-5" style="border:solid 1px black;box-shadow: 5px 5px 3px #afafaf">
		                ...
		                <div class="card col-5" style="border:solid 1px black;margin-left:50px;box-shadow: 5px 5px 3px #afafaf">
		                    <div class="card-content">
		                        <div class="card-body" style="text-align:center">
...
function getMargin(){
	...
	.then(function (resp) {
		...
		console.log("서버 응답 데이터:", resp.data);
        console.log("Labels:", resp.data.labels);
        console.log("매출 데이터:", resp.data.data);
        console.log("예산 데이터:", resp.data.data2);
        console.log("총이익 데이터:", resp.data.profit);
		updateChart(resp.data.data, resp.data.data2,resp.data.labels,resp.data.profit);
		card(resp.data.data,resp.data.data2,resp.data.profit);
	})
...
function updateChart3(){
	axios.post('/bonsa/lastcompareyear', data)
		.then(function (resp) {
			console.log("전년대비 판매량 응답: ", resp);
			if(resp.data[0].growthRate>0){
				$("#lastyear").html("▲"+resp.data[0].growthRate +"%");
