...
<div class="row mb-2 align-items-center">
         <ol class="breadcrumb float-sm-end">
            ...
            <li class="breadcrumb-item active" style="font-size:2rem"><a href="/gmj/gmj${storeNo }/sellingMenu">메뉴별 판매현황</a></li>
         </ol>
   </div>
...
function menu(){
	$.ajax({
		...
		success:function(resp){
			...
			updateBarChart(resp.labels, resp.data);
		}
	})
...
function bestseller(){
	$.ajax({
		...
		success: function (resp) {
            ...
            const dataset = resp.map(item => item.totalAmount);
