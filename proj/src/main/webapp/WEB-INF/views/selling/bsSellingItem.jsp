	...
	<header class="mb-3">
	   ...
	   <div class="row mb-2 align-items-center">
         <ol class="breadcrumb float-sm-end">
            ...
            <li class="breadcrumb-item active" style="font-size:2rem"><a href="/bonsa/sellingItem">품목별 판매현황</a></li>
         </ol>
   </div>
				...
				<div class="row" id="table-hover-row">
					...
					<div class="col-8" style="margin-left:30px">
						<div class="card-header">
							<h4 class="card-title">품목 베스트셀러 TOP5</h4>
						</div>
...
function bestseller(){
	$.ajax({
		...
		success: function (resp) {
			console.log("응답: ", resp);
			const labels = resp.map(item => item.itemNm);
