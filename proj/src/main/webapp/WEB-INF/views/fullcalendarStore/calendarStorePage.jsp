				...
				<div class="row mb-2 align-items-center">
					...
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-end">
							...
							<li class="breadcrumb-item active"><a href="/calendarStore/test">직원근무 캘린더</a></li>
						</ol>
					</div>
				</div>
			</div>
            ...
            <div class="sticky-top mb-3">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">근무일정 배경색 구분</h3>
                </div>
                <div class="card-body">
                  <!-- 외부 이벤트 -->
                  <div id="external-events">
                    <div class="external-event" style="color: white; background-color: #FF6B6B; padding: 5px 10px; border-radius: 5px;">빨간색</div>
					<div class="external-event" style="color: white; background-color: #4ECDC4; padding: 5px 10px; border-radius: 5px;">민트색</div>
					<div class="external-event" style="color: white; background-color: #FFD93D; padding: 5px 10px; border-radius: 5px;">옐로우색</div>
					<div class="external-event" style="color: white; background-color: #5E60CE; padding: 5px 10px; border-radius: 5px;">보라색</div>
					<div class="external-event" style="color: white; background-color: #FF924C; padding: 5px 10px; border-radius: 5px;">오렌지색</div>
                  </div>
                </div>
                <!-- /.card-body -->
              </div>
...
function fnEditTextColor(obj){
	console.log("선택한 색, value : ",obj.value);// 색상 선택 값을 input[type="color"]에 설정
